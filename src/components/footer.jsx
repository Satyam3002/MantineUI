  ...
  return (
    <footer className="bg-[#003B7B] text-white py-16">
      <div className="max-w-7xl mx-auto px-6">
        {/* Apply items-center and text-center on small screens */}
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 text-center md:text-left items-center">
        ...
        {/* Bottom Section */}
        <div className="flex flex-col items-center text-center md:flex-row justify-between mt-16 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row items-center gap-6 mb-4 md:mb-0">
            <button className="text-sm text-gray-300 hover:text-white">English</button>
          ...
          <div className="flex gap-6">
            <a href="#" className="text-gray-300 hover:text-white"><IconBrandFacebook size={20} /></a>
            <a href="#" className="text-gray-300 hover:text-white"><IconBrandTwitter size={20} /></a>
            <a href="#" className="text-gray-300 hover:text-white"><IconBrandLinkedin size={20} /></a>
          </div>
        </div>
      </div>
    </footer>
